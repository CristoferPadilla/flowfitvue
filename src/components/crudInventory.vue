        ...
        <thead>
          <tr>
                    ...
                    <div class="add-form">
                      ...
                      <form @submit.prevent="saveProduct" class="form-container">
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input v-model="newProduct.quantity" type="text" class="form-control" required />
                            </div>
                            <div class="form-group">
                        ...
                        <div class="text-center">
                          <button type="submit" class="btn btn-primary">{{ selectedProduct ? 'Save' : 'Add' }}</button>
            ...
            export default {
              ...
              const selectedProvider = this.providers.find(provider => provider.id === this.newProduct.provider_id);

              this.newProduct.provider_id = selectedProvider ? selectedProvider.id : null;
              ...
              if (this.selectedProduct) {
                ...
                if (index !== -1) {
                  ...
                  axios.put(`https://api-yrrd.onrender.com/products${this.selectedProduct.id}`, this.newProduct, {
                    headers: {
                ...
                axios.post('https://api-yrrd.onrender.com/products', this.newProduct, {
                  headers: {
                    Authorization: `Bearer ${this.token}`,
                  },
                })
              ...
              this.hideForm();
                ...
                if (confirm("Are you sure you want to delete this product?")) {
                  ...
                  axios.delete(`https://api-yrrd.onrender.com/products/${productID}`, {
                    headers: {
                      Authorization: `Bearer ${this.token}`,
                    },
                  })
            ...
            fetchProducts() {
              axios.get('https://api-yrrd.onrender.com/products', {
                headers: {
                  Authorization: `Bearer ${this.token}`, 
                },
              })
            ...
            fetchProviders() {
              axios.get('https://api-yrrd.onrender.com/providers', {
                headers: {
                  Authorization: `Bearer ${this.token}`,
                },
              })
